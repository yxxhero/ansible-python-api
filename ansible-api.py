...
class AnsibleApi(object):
    def __init__(self):
        ...
        self.inventory = InventoryManager(
            loader=self.loader, sources=['./host.install'])
...
if __name__ == "__main__":
    ...
    # ]
    # ansible_instance.runansible(host_list,tasks_list)
    ansible_instance.playbookrun(playbook_path=[''])
